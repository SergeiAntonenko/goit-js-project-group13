import{g as j,a as z,b as N,c as O}from"./assets/support-ukr-d5ca6485.js";import{S as P,i as w}from"./assets/vendor-372b0e6c.js";import"https://cdn.jsdelivr.net/npm/axios@1.3.5/+esm";const g="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg",C="shoppingIdList",S=document.querySelector("body"),T=document.querySelector("#modalBookContainer");let $,k,h,p,a,l,E,r;document.addEventListener("keyup",t=>{t.code==="Escape"&&u()});async function R(t){r=t,l=JSON.parse(localStorage.getItem(C))||[],E=await j(r),a=l.includes(r);const o=W(E);T.insertAdjacentHTML("afterbegin",o),$=document.querySelector("#bookActionContainer"),J(),q(),Q(),S.classList.add("overflow-hidden")}function u(){h.removeEventListener("click",u),p.removeEventListener("click",v),k.removeEventListener("click",x),T.innerHTML="",S.classList.remove("overflow-hidden")}function v(){p.removeEventListener("click",v),a?l=l.filter(o=>o!==r):l.push(r),localStorage.setItem(C,JSON.stringify(l)),a=!a;const t=M();$.innerHTML=t,q()}function W(t){var y,f;const{book_image:o,author:e,title:s,description:i,buy_links:d}=t,A=((y=d.find(m=>m.name==="Amazon"))==null?void 0:y.url)||"https://www.amazon.com/",D=((f=d.find(m=>m.name==="Apple Books"))==null?void 0:f.url)||"https://www.apple.com/apple-books/";return`
  ...
  `}function J(){h=document.querySelector("#modalClose"),h.addEventListener("click",u)}function q(){p=document.querySelector("#shoppingListBtn"),p.addEventListener("click",v)}function Q(){k=document.querySelector("#modalBookBackground"),k.addEventListener("click",x)}function x(t){t.target===t.currentTarget&&u()}const L=document.querySelector(".js-backdrop");let U={lines:14,length:12,width:8,radius:25,scale:.6,corners:1,speed:1,rotate:0,animation:"spinner-line-fade-quick",direction:1,color:"#4F2EE8",fadeColor:"transparent",top:"40%",left:"50%",shadow:"0 0 1px transparent",zIndex:999,className:"spinner",position:"absolute"};const H=new P(U),Y=()=>{L.classList.remove("is-hidden"),H.spin(L)},F=()=>{L.classList.add("is-hidden"),H.stop()};function G(){w.error({title:"Warning",message:"There are no more books in this category",position:"topCenter"})}const n={topListElem:document.querySelector("#topList"),categoryListElem:document.querySelector("#categoryList"),titleElement:document.querySelector(".top_list-title")};let b=!1;document.addEventListener("DOMContentLoaded",function(){document.addEventListener("click",X),document.addEventListener("click",c),document.addEventListener("click",Z),window.addEventListener("scroll",tt)});document.addEventListener("DOMContentLoaded",async function(){Y(),n.topListElem.innerHTML="",(await z()).forEach(e=>{K(e)}),F()});function K(t){const o=`
