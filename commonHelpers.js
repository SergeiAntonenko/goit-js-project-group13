import{s as R,i as _,g as j,a as C,b as z,c as T,d as P,e as W}from"./assets/mob-menu-d15f98b4.js";import{i as L}from"./assets/vendor-372b0e6c.js";import"https://cdn.jsdelivr.net/npm/axios@1.3.5/+esm";const p="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg",$=document.querySelector("body"),S=document.querySelector("#modalBookContainer");let M,g,k,r,d,E,c;document.addEventListener("keyup",t=>{t.code==="Escape"&&u()});async function O(t){c=t,E=await j(c),d=_(c);const o=N(E);S.insertAdjacentHTML("afterbegin",o),M=document.querySelector("#bookActionContainer"),Q(),x(),U(),$.classList.add("overflow-hidden")}function u(){k.removeEventListener("click",u),r.removeEventListener("click",b),g.removeEventListener("click",H),S.innerHTML="",$.classList.remove("overflow-hidden")}function b(){r.removeEventListener("click",b),R(c),d=_(c);const t=q();M.innerHTML=t,x()}function N(t){var f,y;const{book_image:o,author:e,title:n,description:i,buy_links:v}=t,I=((f=v.find(m=>m.name==="Amazon"))==null?void 0:f.url)||"https://www.amazon.com/",D=((y=v.find(m=>m.name==="Apple Books"))==null?void 0:y.url)||"https://www.apple.com/apple-books/";return`
  ...
  `}function Q(){k=document.querySelector("#modalClose"),k.addEventListener("click",u)}function x(){r=document.querySelector("#shoppingListBtn"),r.addEventListener("click",b)}function U(){g=document.querySelector("#modalBookBackground"),g.addEventListener("click",H)}function H(t){t.target===t.currentTarget&&u()}function Y(){L.show({message:"There are no more books in this category",position:"topRight",backgroundColor:"#eac645"})}function F(){L.show({message:"There are no more categories in this library",position:"topRight",backgroundColor:"#eac645"})}const s={topListElem:document.querySelector("#topList"),categoryListElem:document.querySelector("#categoryList"),titleElement:document.querySelector(".top_list-title")};let h=!1;document.addEventListener("DOMContentLoaded",function(){document.addEventListener("click",K),document.addEventListener("click",l),document.addEventListener("click",V),window.addEventListener("scroll",X)});document.addEventListener("DOMContentLoaded",async function(){C(s.titleElement),s.topListElem.innerHTML="";const o=await z();let e="";o.forEach(n=>{e+=G(n)}),s.topListElem.innerHTML=e,T()});function G(t){return`
    ...
    `}function J(t){let o=1;const e=t.map(n=>`
    ...
    `).join("");return o++,e}const l=function(t){var o;if((o=t.target.parentElement)!=null&&o.classList.contains("top_list-book_cover_wrapper")){const e=t.target.parentElement.dataset.bookid;O(e)}},K=function(t){if(t.target.classList.contains("top_list-see_more")){s.topListElem.classList.add("hidden"),s.categoryListElem.classList.remove("hidden");const o=t.target.dataset.category;w(o),B(o),document.removeEventListener("click",l),document.addEventListener("click",l),a()}if(t.target.classList.contains("gallery-link")){s.topListElem.classList.add("hidden"),s.categoryListElem.classList.remove("hidden");const o=t.target.textContent.trim();w(o),B(o),a(),document.removeEventListener("click",l),document.addEventListener("click",l),a()}},V=async function(t){(t.target.classList.contains("all_categories")||t.target.classList.contains("link"))&&(s.titleElement.innerHTML="Best Sellers <span>Books</span>",s.categoryListElem.classList.add("hidden"),s.topListElem.classList.remove("hidden"),a())};async function B(t){C(s.titleElement),s.categoryListElem.innerHTML="";const e=await P(t);let n="";e.forEach(i=>{n+=`
        ...
        `}),n+='<li><button class="all_categories">All Categories</button></li>',s.categoryListElem.innerHTML=n,T()}function w(t){const e=t.split(" "),n=e.pop();s.titleElement.textContent=e.join(" ");const i=document.createElement("span");i.textContent=" "+n,s.titleElement.appendChild(i),h=!1}function X(){const t=document.querySelector(".all_categories");if(t){const o=t.getBoundingClientRect(),e=window.innerHeight||document.documentElement.clientHeight;o.top<e&&!h&&s.topListElem.classList.contains("hidden")&&(Y(),h=!0)}}function a(){const t=window.innerWidth||document.documentElement.clientWidth,o=s.titleElement;t<1440&&setTimeout(function(){const e=o.getBoundingClientRect().top-60;window.scrollTo({top:e,behavior:"smooth"})},1100)}function Z(){return window.innerHeight+window.scrollY>=document.body.offsetHeight}window.addEventListener("scroll",function(){Z()&&s.titleElement.textContent.trim()==="Best Sellers Books"&&F()});const tt=document.querySelector(".all-categories");function ot(t){return t.map(e=>`
            <li class="gallery-item">
            <a class="gallery-link" href=#>${e.list_name}
            </a>
          </li>`).join("")}function et(t){tt.insertAdjacentHTML("beforeend",t)}W().then(t=>ot(t)).then(t=>{et(t),nt(),st()}).catch(t=>L.error({maxWidth:"432px",messageColor:"rgb(250, 250, 251)",messageSize:"16px",backgroundColor:"rgb(239, 64, 64)",position:"topRight",message:`${t}`}));function nt(){const t=document.querySelectorAll(".gallery-link"),o=document.querySelector(".link");t.forEach(e=>{e.addEventListener("click",()=>{o.classList.remove("all-categories-link")})})}function st(){const t=document.querySelectorAll(".gallery-link");let o=0;t.forEach((e,n)=>{e.addEventListener("click",()=>{t[o].classList.remove("active"),o=n,t[o].classList.add("active")})})}const A=document.getElementById("scrollToTopBtn");document.body.scrollTop=0;document.documentElement.scrollTop=0;A.addEventListener("click",lt);window.addEventListener("scroll",it);function it(){document.body.scrollTop>20||document.documentElement.scrollTop>20?(document.getElementById("scrollToTopBtn").style.display="block",A.classList.remove("visually-hidden")):document.getElementById("scrollToTopBtn").style.display="none"}function lt(){window.scrollTo({top:0,behavior:"smooth"})}
