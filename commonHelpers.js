import{g as j,s as B,a as z,b as w,c as O,d as P}from"./assets/mob-menu-5266530f.js";import{i as C}from"./assets/vendor-372b0e6c.js";import"https://cdn.jsdelivr.net/npm/axios@1.3.5/+esm";const p="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg",S="shoppingIdList",T=document.querySelector("body"),$=document.querySelector("#modalBookContainer");let M,g,k,d,c,l,f,r;document.addEventListener("keyup",t=>{t.code==="Escape"&&u()});async function R(t){r=t,l=JSON.parse(localStorage.getItem(S))||[],f=await j(r),c=l.includes(r);const o=N(f);$.insertAdjacentHTML("afterbegin",o),M=document.querySelector("#bookActionContainer"),W(),x(),J(),T.classList.add("overflow-hidden")}function u(){k.removeEventListener("click",u),d.removeEventListener("click",L),g.removeEventListener("click",H),$.innerHTML="",T.classList.remove("overflow-hidden")}function L(){d.removeEventListener("click",L),c?l=l.filter(o=>o!==r):l.push(r),localStorage.setItem(S,JSON.stringify(l)),c=!c;const t=q();M.innerHTML=t,x()}function N(t){var v,y;const{book_image:o,author:e,title:n,description:i,buy_links:b}=t,A=((v=b.find(m=>m.name==="Amazon"))==null?void 0:v.url)||"https://www.amazon.com/",D=((y=b.find(m=>m.name==="Apple Books"))==null?void 0:y.url)||"https://www.apple.com/apple-books/";return`
