...
<div class="book-background" id="modalBookContainer">
    <div class="modal-container">
        <button class="modal-close" id="modalClose">
            <svg class="header-menu-svg" class="modal-close-icon" width="12" height="12">
                <use href="./img/modal/close.svg"></use>
            </svg>
        </button>
        <div class="book-box">
            ...
            <div class="book-description-box">
                ...
                <ul class="book-shop-list">
                    <li class="book-shop-item">
                        ...
                        <img src="./img/modal/amazon-logo.svg" alt="amazon logo" class="book-shop-logo amazon-logo" width="62" height="19">
                        </a>
                    </li>
                    <li class="book-shop-item">
                        <a href="${iBooksUrl}" class="book-shop-link" target="_blank">
                        <img src="./img/modal/ibooks-logo.svg" alt="ibooks logo" class="book-shop-logo ibooks-logo" width="32" height="32">    
                        </a>
                    </li>
                </ul>
            </div>
    ...
    `
                        ...
                        // <svg class="header-menu-svg" class="book-shop-logo amazon-logo" width="62" height="19">
                        //     <use href="./img/modal/amazon-logo.svg"></use>
                        // </svg>

                        // <svg class="header-menu-svg" class="book-shop-logo ibooks-logo" width="32" height="32">
                        //     <use href="./img/modal/ibooks-logo.svg"></use>
                        // </svg>