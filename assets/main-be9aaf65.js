import m from"https://cdn.jsdelivr.net/npm/axios@1.3.5/+esm";import{i as P}from"./vendor-ad859c2f.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(e){if(e.ep)return;e.ep=!0;const r=n(e);fetch(e.href,r)}})();const h="https://books-backend.p.goit.global",k=["/books/category-list","/books/top-books","/books/category","/books"];async function j(){const t=`${h}${k[0]}`;try{return(await m.get(t)).data}catch(o){throw console.error("Error fetching category list: ",o),o}}async function D(){const t=`${h}${k[1]}`;try{return(await m.get(t)).data}catch(o){throw console.error("Error fetching Top Books list: ",o),o}}async function z(t){const o=`${h}${k[2]}`,n={category:t};try{return(await m.get(o,{params:n})).data}catch(s){throw console.error("Error fetching books by category name: ",s),s}}async function N(t){const o=`${h}${k[3]}/${t}`;try{return(await m.get(o)).data}catch(n){throw console.error("Error fetching book by id: ",n),n}}const f="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg",T="shoppingIdList",C=document.querySelector("body"),M=document.querySelector("#modalBookContainer");let I,L,g,d,a,_,u;async function R(t){u=t,a=JSON.parse(localStorage.getItem(T))||[],_=await N(u),d=a.includes(u);const o=U(_);M.insertAdjacentHTML("afterbegin",o),I=document.querySelector("#bookActionContainer"),F(),H(),C.classList.add("overflow-hidden")}function q(){L.removeEventListener("click",q),g.removeEventListener("click",w),M.innerHTML="",C.classList.remove("overflow-hidden")}function w(){g.removeEventListener("click",w),d?a=a.filter(o=>o!==u):a.push(u),localStorage.setItem(T,JSON.stringify(a)),d=!d;const t=A();I.innerHTML=t,H()}function U(t){var y,S;const{book_image:o,author:n,title:s,description:e,buy_links:r}=t,l=((y=r.find(b=>b.name==="Amazon"))==null?void 0:y.url)||"https://www.amazon.com/",E=((S=r.find(b=>b.name==="Apple Books"))==null?void 0:S.url)||"https://www.apple.com/apple-books/";return`
    <div class="book-background" id="modalBookContainer">
      <div class="modal-container">
        ...
        <div class="book-box">
          ...
          <div class="book-description-box">
            ...
            <ul class="book-shop-list">
              ...
              <li class="book-shop-item">
                <a href="${E}" class="book-shop-link" target="_blank">
        ...
        <div class="book-action" id="bookActionContainer">${A()}</div>
      </div>
    </div>
  `}function A(){return`
  ...
  `}function F(){L=document.querySelector("#modalClose"),L.addEventListener("click",q)}function H(){g=document.querySelector("#shoppingListBtn"),g.addEventListener("click",w)}const i={topListElem:document.querySelector("#topList"),categoryListElem:document.querySelector("#categoryList"),titleElement:document.querySelector(".top_list-title")};document.addEventListener("DOMContentLoaded",function(){document.addEventListener("click",K),document.addEventListener("click",p),document.addEventListener("click",Q)});document.addEventListener("DOMContentLoaded",async function(){i.topListElem.innerHTML="",(await D()).forEach(n=>{W(n)})});function W(t){const o=`
        ...
        `;i.categoryListElem.innerHTML+=r});const s='<li><button class="all_categories">All Categories</button></li>';i.categoryListElem.innerHTML+=s}function B(t){const n=t.split(" "),s=n.pop();i.titleElement.textContent=n.join(" ");const e=document.createElement("span");e.textContent=" "+s,i.titleElement.appendChild(e)}const Y=document.querySelector(".all-categories");function G(t){return t.map(n=>`
          ...
          <span class="supporters-number">${(s+1).toString().padStart(2,"0")}</span>
            ...
            >
              ...
              `}).join("");tt.innerHTML=`${o}`};ot(X);function et(t,o){const n=-t.scrollTop/(o/15),s=setInterval(function(){t.scrollTop!=0?t.scrollBy(0,n):clearInterval(s)},15)}function st(){const t=document.querySelector(".swiper"),o=500;if(t.scrollTop+t.clientHeight>=t.scrollHeight){et(t,o);const s=document.querySelector(".supporters-btn-icon");s.style.transform="rotate(180deg)"}else{t.scrollBy({top:300,behavior:"smooth"});const s=document.querySelector(".supporters-btn-icon");s.style.transform="rotate(0deg)"}}const nt=document.querySelector(".supporters-btn");nt.addEventListener("click",st);const O=document.getElementById("scrollToTopBtn");document.body.scrollTop=0;document.documentElement.scrollTop=0;O.addEventListener("click",it);window.addEventListener("scroll",rt);function rt(){document.body.scrollTop>20||document.documentElement.scrollTop>20?(document.getElementById("scrollToTopBtn").style.display="block",O.classList.remove("visually-hidden")):document.getElementById("scrollToTopBtn").style.display="none"}function it(){window.scrollTo({top:0,behavior:"smooth"})}
//# sourceMappingURL=main-be9aaf65.js.map
