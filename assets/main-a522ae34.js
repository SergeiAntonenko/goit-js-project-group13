import u from"https://cdn.jsdelivr.net/npm/axios@1.3.5/+esm";import{i as I}from"./vendor-ad859c2f.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))e(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&e(a)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function e(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();const m="https://books-backend.p.goit.global",h=["/books/category-list","/books/top-books","/books/category","/books"];async function O(){const t=`${m}${h[0]}`;try{return(await u.get(t)).data}catch(o){throw console.error("Error fetching category list: ",o),o}}async function T(){const t=`${m}${h[1]}`;try{return(await u.get(t)).data}catch(o){throw console.error("Error fetching Top Books list: ",o),o}}async function A(t){const o=`${m}${h[2]}`,s={category:t};try{return(await u.get(o,{params:s})).data}catch(e){throw console.error("Error fetching books by category name: ",e),e}}async function D(t){const o=`${m}${h[3]}/${t}`;try{return(await u.get(o)).data}catch(s){throw console.error("Error fetching book by id: ",s),s}}const f="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg",x="shoppingIdList",E=document.querySelector("body"),C=document.querySelector("#modalBookContainer");let M,v,g,l,c,$,p;async function P(t){p=t,c=JSON.parse(localStorage.getItem(x))||[],$=await D(p),l=c.includes(p);const o=j($);C.insertAdjacentHTML("afterbegin",o),M=document.querySelector("#bookActionContainer"),z(),q(),E.classList.add("overflow-hidden")}function B(){v.removeEventListener("click",B),g.removeEventListener("click",w),C.innerHTML="",E.classList.remove("overflow-hidden")}function w(){g.removeEventListener("click",w),l?c=c.filter(o=>o!==p):c.push(p),localStorage.setItem(x,JSON.stringify(c)),l=!l;const t=U();M.innerHTML=t,q()}function j(t){var b,_;const{book_image:o,author:s,title:e,description:r,buy_links:i}=t,a=((b=i.find(y=>y.name==="Amazon"))==null?void 0:b.url)||"https://www.amazon.com/",k=((_=i.find(y=>y.name==="Apple Books"))==null?void 0:_.url)||"https://www.apple.com/apple-books/";return`
  ...
  `}function z(){v=document.querySelector("#modalClose"),v.addEventListener("click",B)}function q(){g=document.querySelector("#shoppingListBtn"),g.addEventListener("click",w)}const d={topListElem:document.querySelector("#topList"),categoryListElem:document.querySelector("#categoryList"),titleElement:document.querySelector(".top_list-title")};document.addEventListener("DOMContentLoaded",async function(){d.topListElem.innerHTML="",(await T()).forEach(s=>{H(s)})});function H(t){const o=`
...
//# sourceMappingURL=main-a522ae34.js.map
