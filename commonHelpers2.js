import{s as h,e as b,b as k}from"./assets/mob-menu-1e45bd9a.js";import{P as y}from"./assets/vendor-372b0e6c.js";import"https://cdn.jsdelivr.net/npm/axios@1.3.5/+esm";const L="/goit-js-project-group13/assets/trash-03-478df87d.svg",I="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg#icon-amazon-logo",B="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg#icon-ibooks-logo",i={bookList:document.querySelector(".shopping-list-saved"),emptyList:document.querySelector(".shopping-list-empty"),pagination:document.querySelector(".tui-pagination")},g=window.innerWidth>=768?3:4;m();function l(){const e=localStorage.getItem("shoppingIdList");return JSON.parse(e)}async function m(){const e=l();if(h(i.bookList),!e||e.length===0)p(i.emptyList),A(i.pagination);else{const t=await b(e);if(t&&t.length!==0){const a=H(t,g),s=n.getCurrentPage();$(a[s-1]),p(i.pagination),document.querySelectorAll(".saved-item-delete-btn").forEach(o=>o.addEventListener("click",S))}}k()}function P(e){return e.map(({_id:t,book_image:a,title:s,list_name:o,description:u,author:v,buy_links:f})=>{const d=f.reduce((c,r)=>(r.name==="Amazon"&&(c.amazon=r.url),r.name==="Apple Books"&&(c.apple=r.url),c),{});return`<li class="saved-item">
