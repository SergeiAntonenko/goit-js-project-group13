import{f as c,a as f,h as b,c as k,r as y}from"./assets/mob-menu-c76d503d.js";import{P as L}from"./assets/vendor-372b0e6c.js";import"https://cdn.jsdelivr.net/npm/axios@1.3.5/+esm";const B="/goit-js-project-group13/assets/trash-03-478df87d.svg",P="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg#icon-amazon-logo",$="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg#icon-ibooks-logo",a={bookList:document.querySelector(".shopping-list-saved"),emptyList:document.querySelector(".shopping-list-empty"),pagination:document.querySelector(".tui-pagination")},g=window.innerWidth>=768?3:4;m();async function m(){const e=c();if(f(a.bookList),!e||e.length===0)p(a.emptyList),j(a.pagination);else{const t=await b(e);if(t&&t.length!==0){const i=S(t,g),s=o.getCurrentPage();I(i[s-1]),p(a.pagination),document.querySelectorAll(".saved-item-delete-btn").forEach(r=>r.addEventListener("click",w))}}k()}function A(e){return e.map(({_id:t,book_image:i,title:s,list_name:r,description:u,author:v,buy_links:h})=>{const d=h.reduce((l,n)=>(n.name==="Amazon"&&(l.amazon=n.url),n.name==="Apple Books"&&(l.apple=n.url),l),{});return`<li class="saved-item">
