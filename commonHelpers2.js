import{f as l,a as k,h as y,c as L,r as $}from"./assets/mob-menu-2b105490.js";import{P}from"./assets/vendor-372b0e6c.js";import"https://cdn.jsdelivr.net/npm/axios@1.3.5/+esm";const B="/goit-js-project-group13/assets/trash-03-478df87d.svg",j="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg#icon-amazon-logo",w="/goit-js-project-group13/assets/modal-icons-6da17b7d.svg#icon-ibooks-logo",p="/goit-js-project-group13/assets/icons-shop-5d5cc664.svg",i={bookList:document.querySelector(".shopping-list-saved"),emptyList:document.querySelector(".shopping-list-empty"),pagination:document.querySelector(".tui-pagination")},m=window.innerWidth>=768?3:4,I=window.innerWidth>=768?3:2;v();async function v(){const e=l();if(g(i.pagination),k(i.bookList),!e||e.length===0)u(i.emptyList),g(i.pagination);else{const s=await y(e);if(s&&s.length!==0){const a=z(s,m),t=o.getCurrentPage();H(a[t-1]),u(i.pagination),document.querySelectorAll(".saved-item-delete-btn").forEach(r=>r.addEventListener("click",M))}}L()}function A(e){return e.map(({_id:s,book_image:a,title:t,list_name:r,description:h,author:f,buy_links:b})=>{const d=b.reduce((c,n)=>(n.name==="Amazon"&&(c.amazon=n.url),n.name==="Apple Books"&&(c.apple=n.url),c),{});return`<li class="saved-item">
